...
The deliverables described above are intended to be used by any substrate based project that would like to leverage an easily zero-knowledge and performant STARK 
based virtual machine.  This project makes zero-knowledge technology more accessible to developers within the substrate ecosystem.  The table below describes
the similarites / differences of other zero-knowledge projects in the substrate ecosystem.
